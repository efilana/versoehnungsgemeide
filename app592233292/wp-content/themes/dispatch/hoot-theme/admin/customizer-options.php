...
function hoot_theme_customizer_options() {
	...
	$sections[ $section ] = array(
		'title'       => __( 'Demo / Support', 'dispatch' ),
		'priority'    => '2',
	);
	...
	$lcontent .= '<a class="hoot-cust-link" href="' .
				 ...
				 __( "Rate Us", 'dispatch') . 
				 '</span><span class="hoot-cust-link-desc">' .
				 __( "If you are happy with the theme, give us a 5 star rating on wordpress.org", 'dispatch') .
				 '</span></a>';
	...
	$sections[ $section ] = array(
		...
		'description' => __('Control various color options in the premium version for fonts, backgrounds, contrast, highlight, accent etc.', 'dispatch'),
	);
